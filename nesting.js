...
function removeDuplicates() {
  let newWorkplaceAccidents = [];
  for (var i=0; i<workplaceAccidents.length; i++) {
    if(newWorkplaceAccidents.indexOf(workplaceAccidents[i]) === -1) {
      newWorkplaceAccidents.push(workplaceAccidents[i]);
      }
    }
    workplaceAccidents = newWorkplaceAccidents;
